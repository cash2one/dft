 ...
 *2006-10-12
 * <p>Title: </p>
 * <p>Description: 增加一个通用类，为导出到excel提供格式</p>
...
public class Style{
  ...
  public static short TABLEHEAD_HEIGHT_BIG=1000;
  public static short TABLECONTENT_HEIGHT=500;
  public static short TABLECONTENT_HEIGHT_BIG=900;
  ...
  /**
   * 小数正文内容格式，水平靠右，垂直居中，有表格线，字体为Arial，保留2位小数
   * @param wb
   * @return CellStyle
   */
  public CellStyle get2DecimalContStyle(Workbook wb){
	  if(decimalContStyle==null){
		  decimalContStyle = wb.createCellStyle();
	      Font fLnode = wb.createFont();
	      fLnode.setFontName("Arial");
	      fLnode.setFontHeightInPoints( (short) 9);
	      fLnode.setBoldweight(Font.BOLDWEIGHT_NORMAL);       //不加粗
	      decimalContStyle.setFont(fLnode);
	      decimalContStyle.setAlignment(CellStyle.ALIGN_RIGHT);             //水平靠右
	      decimalContStyle.setVerticalAlignment(CellStyle.VERTICAL_CENTER);
	      decimalContStyle.setBorderBottom(CellStyle.BORDER_THIN);
	      decimalContStyle.setBorderLeft(CellStyle.BORDER_THIN);
	      decimalContStyle.setBorderRight(CellStyle.BORDER_THIN);
	      decimalContStyle.setBorderTop(CellStyle.BORDER_THIN);
	      decimalContStyle.setDataFormat(HSSFDataFormat.getBuiltinFormat("0.00"));
	  }
      return decimalContStyle;
  }
  /**
   * 
   * @param wb
   ...
   * @return CellStyle
   */
public CellStyle get2DecimalSecStyle(Workbook wb){
	if(decimalSecStyle==null){
		decimalSecStyle= wb.createCellStyle();
		Font fPnode = wb.createFont();
		fPnode.setFontHeightInPoints( (short) 9);
		fPnode.setFontName("Arial");
		fPnode.setBoldweight(Font.BOLDWEIGHT_BOLD);        //加粗
		decimalSecStyle.setFont(fPnode);
		decimalSecStyle.setAlignment(CellStyle.ALIGN_RIGHT);             //水平靠右
		decimalSecStyle.setVerticalAlignment(CellStyle.VERTICAL_CENTER);
		decimalSecStyle.setBorderBottom(CellStyle.BORDER_THIN);
		decimalSecStyle.setBorderLeft(CellStyle.BORDER_THIN);
		decimalSecStyle.setBorderRight(CellStyle.BORDER_THIN);
		decimalSecStyle.setBorderTop(CellStyle.BORDER_THIN);
		decimalSecStyle.setDataFormat(HSSFDataFormat.getBuiltinFormat("0.00"));
	}
	return decimalSecStyle;
}
/**
 * 
 * @param wb
...
* @return
 */
public CellStyle getStrContStyleBIG(Workbook wb){
	if(strContStyleBIG==null){
		strContStyleBIG = wb.createCellStyle();
	    Font fLnode = wb.createFont();
	    fLnode.setFontName("Arial");
	    fLnode.setFontHeightInPoints( (short) 12);
	    fLnode.setBoldweight(Font.BOLDWEIGHT_NORMAL);      //不加粗
	    strContStyleBIG.setFont(fLnode);
	    strContStyleBIG.setAlignment(CellStyle.ALIGN_LEFT);             //水平靠左
	    strContStyleBIG.setVerticalAlignment(CellStyle.VERTICAL_CENTER);
	    strContStyleBIG.setBorderBottom(CellStyle.BORDER_THIN);
	    strContStyleBIG.setBorderLeft(CellStyle.BORDER_THIN);
	    strContStyleBIG.setBorderRight(CellStyle.BORDER_THIN);
	    strContStyleBIG.setBorderTop(CellStyle.BORDER_THIN);
	    strContStyleBIG.setWrapText(true);
	}
    return strContStyleBIG;
}
  /**
